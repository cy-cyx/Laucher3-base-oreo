...
open class DefaultItemAnimOpen : SimpleItemAnimator() {
    protected var mPendingRemovals = ArrayList<RecyclerView.ViewHolder>()
    protected var mPendingAdditions = ArrayList<RecyclerView.ViewHolder>()
    protected var mPendingMoves = ArrayList<MoveInfo>()
    protected var mPendingChanges = ArrayList<ChangeInfo>()
    ...
    protected fun animateRemoveImpl(holder: RecyclerView.ViewHolder) {
    ...
    protected fun resetAnimation(holder: RecyclerView.ViewHolder) {
