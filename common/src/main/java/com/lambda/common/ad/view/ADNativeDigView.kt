...
import com.lambda.common.databinding.LayoutAdFixBinding

class ADNativeDigView @JvmOverloads constructor(
    ...
    public fun loadAd(p: String) {
        ...
        nativeView =
            AdUtil.populateNativeAdViewMax2(
                context,
                R.layout.layout_native_ad_max_2
            )
        nativeView1 = AdUtil.populateNativeAdViewAdmob2(
            context,
            R.layout.layout_native_ad_admob_2
        )
        nativeViewPangle =
            LayoutInflater.from(context).inflate(R.layout.layout_native_ad_pangle_2, null)
