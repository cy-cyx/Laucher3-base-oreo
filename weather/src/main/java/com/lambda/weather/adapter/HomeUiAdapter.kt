...
import com.lambda.weather.databinding.ItemAllLayoutHomeAdBinding
import com.lambda.weather.databinding.ItemAllLayoutHomeAirBinding
import com.lambda.weather.databinding.ItemAllLayoutHomeClothBinding
import com.lambda.weather.databinding.ItemAllLayoutHomeDailyBinding
import com.lambda.weather.databinding.ItemAllLayoutHomeHourlyBinding
import com.lambda.weather.databinding.ItemAllLayoutHomeIndexBinding
import com.lambda.weather.databinding.ItemAllLayoutHomeNewBinding
import com.lambda.weather.databinding.ItemAllLayoutHomeSunsetBinding
import com.lambda.weather.databinding.ItemAllLayoutHomeTravelBinding
import com.lambda.weather.ui.WeatherFragment
    ...
    private fun initNews(holder: BaseViewHolder, model: NewsModel?) {
        ...
        binding.includedLayoutHomeNew.rvBanner.setOnRvBannerClickListener(object :
            ...
            override fun onClick(date: NewsModel.NewsDTO) {
                LambdaWeather.openNewDetailActivity(context, GsonUtil.gson.toJson(date))
            }
        })
