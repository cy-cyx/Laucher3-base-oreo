...
class WeatherHourlyView @JvmOverloads constructor(
     ...
     * 白天折线颜色
     */
    private val mColorDay: Int = Color.parseColor("#ffffff")

    /**
     * 夜间折线颜色
     */
    private val mColorNight: Int = Color.parseColor("#ffffff")

    /**
     * 字体颜色
     */
    private val mTextColor: Int = Color.parseColor("#353131")
        ...
        for (i in 0 until LENGTH) {
            ...
            if (i < LENGTH - 1) {
                if (type == 0) {
                    ...
                    linePaint.style = Paint.Style.FILL //设置实心
                    ...
                    path.lineTo(mXAxis[i], mYAxisDay[i])

                    linePaint.shader = LinearGradient(
                        0f, 0f, 0f, mYAxisNight[i],
                        intArrayOf(
                            ContextCompat.getColor(context, R.color.color_00ffff),
                            ContextCompat.getColor(context, R.color.white_empty2)
                        ),
                        null,
