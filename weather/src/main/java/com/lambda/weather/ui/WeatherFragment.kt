...
import com.lambda.weather.databinding.FragmentWeather2Binding
import com.lambda.weather.databinding.ItemAllLayoutHomeTopBinding
...
class WeatherFragment : BaseFragment<FragmentWeather2Binding>() {
    ...
    override fun onDestroyView() {
        super.onDestroyView()
        viewBinding.weatherView.onDestroy()
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.mLocation.observe(viewLifecycleOwner) {
            if (null != it) {
                viewBinding.tvTitle.text = it.getLocalName()
    ...
    override fun onResume() {
        super.onResume()
        viewBinding.weatherView.onResume()
    }
    ...
    private fun initAll() {
        ...
        viewModel.weatherType.observe(this.viewLifecycleOwner) {
            viewBinding.weatherView.setDrawerType(it)
        }
        initHome()
    }

    private fun initHome() {
        LambdaWeather.callUpdateAboutWeather()
    ...
    private fun initAdapter() {
        ...
        viewBinding.rvHome.layoutManager = manager
        ...
        viewBinding.rvHome.itemAnimator = anim
        viewBinding.rvHome.adapter = ScaleInAnimationAdapter(mAdapter)
